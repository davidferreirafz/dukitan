...
<form enctype="multipart/form-data" method="post" action="<?php echo $PATH_APP ?>package/action/importar_texto_padrao.php" name="form">
  <table style="width: 381px; text-align: left; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">

    <caption>Importar Texto Padr&atilde;o</caption><tbody>
