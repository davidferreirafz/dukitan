...
<form enctype="multipart/form-data" method="post" action="<?php echo $PATH_APP ?>package/action/editar_texto_traduzido.php" name="form">
  <table style="width: 381px; text-align: left; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">

    <caption><h2>Editar Texto Traduzido</h2></caption><tbody>
...
<div style="text-align: center;">
        <?php 
			echo gridTexto($PATH_APP.'/package/action/crud_texto.php',$id_software,$id_idioma,$letra); 
        ?>
</div>
</body>
</html>
