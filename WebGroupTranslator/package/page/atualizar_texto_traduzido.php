...
<head>
  ...
  <title>Atualizar dos Textos Traduzidos</title>
...
function validarSubmit(){
	...
	document.form.acao.disabled=true;
...
<form enctype="multipart/form-data" method="post" action="<?php echo $PATH_APP ?>package/action/atualizar_texto_traduzido.php" name="form">
  <table style="width: 381px; text-align: left; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">

    <caption>Atualizar Texto Traduzido</caption><tbody>
  ...
  <div style="text-align: center;"><input value="Atualizar" name="acao" type="button" onclick="javascript:validarSubmit();"><br>
