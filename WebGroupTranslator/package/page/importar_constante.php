...
<head>
  ...
  <title>Importa&ccedil;&atilde;o das Constantes</title>
...
<form enctype="multipart/form-data" method="post" action="<?php echo $PATH_APP ?>package/action/importar_constante.php" name="form">
  <table style="width: 381px; text-align: left; margin-left: auto; margin-right: auto;" border="1" cellpadding="2" cellspacing="2">

    <caption>Importar Constantes do Software</caption><tbody>
