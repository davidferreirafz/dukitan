...
public class UserInformation extends JPanel
{
	...
	public UserInformation(String titulo)
	{
		...
		labelUsuario.setText("Usuário do Esquema:");
		...
		donoQuantidade.setBounds(new java.awt.Rectangle(150,10,82,61));		
		...
		usuarioQuantidade.setBounds(new java.awt.Rectangle(150,40,82,61));
		...
		diferencaQuantidade.setBounds(new java.awt.Rectangle(150,70,82,61));
